...
const SidebarLogo = (props: PropsType) => {
  ...
  return (
    <div className="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
      <Link to="/dashboard" className="menu-link without-sub white mx-auto">
        <div className="card-title fw-bold text-light app-sidebar-logo-default">
          <img src={toAbsoluteUrl("media/svg/logo.svg")} height={65} width={65}/>
        </div>
        <div className="card-title fw-bold text-light app-sidebar-logo-minimize">
          <img src={toAbsoluteUrl("media/svg/logo.svg")} height={65} width={65}/>
        </div>
      </Link>
